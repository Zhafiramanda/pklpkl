		...
		<ul class="side-menu top">
            ...
            <li>
				<a href="{{ route('list-alumni') }}">
					...
					<span class="text">Manajemen Akun Alumni</span>
				</a>
			</li>
			<li>
					...
					<table>
						...
						<tbody>
							...
							<tr>
								...
								<td><span class="status NotVerified">Not Verified</span></td>
							</tr>
						</tbody>
					</table>
				</div>
				<!-- Your Blade template code for a calendar -->
                <div class="calendar">
                    <div class="head">
                        <h3>Calendar</h3>
                    ...
                    {{-- <ul class="calendar-events">
                        @foreach($calendarEvents as $event)
                            <li class="{{ $event->completed ? 'completed' : 'not-completed' }}">
                                <p>{{ $event->title }}</p>
